...
```bash
curl --location 'http://localhost:8080/api/v1/engine/process' \
...
--data '{
    ...
    "kPeriods": [
        {
            "id": "K1",
            "startInclusive": "2024-01-01 00:00:00",
            "endExclusive": "2024-02-01 00:00:00"
        },
        {
            "id": "K2",
            "startInclusive": "2024-02-01 00:00:00",
            "endExclusive": "2024-03-01 00:00:00"
        },
        {
            "id": "K3",
            "startInclusive": "2024-03-01 00:00:00",
            "endExclusive": "2024-04-01 00:00:00"
        }
    ],
    "defaultCeiling": 2000.00,
    "inflationRate": 0.02,
    "taxCap": 500.00
}'
```
